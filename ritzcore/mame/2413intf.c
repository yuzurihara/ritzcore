...
void ym2413_device::device_start()
{
	...
	m_stream = stream_alloc(0,2,rate); // ritz
...
//[ritz] WRITE8_MEMBER( ym2413_device::register_port_w ) { write(space, 0, data); }
//[ritz] WRITE8_MEMBER( ym2413_device::data_port_w ) { write(space, 1, data); }
WRITE8_MEMBER( ym2413_device::register_port_w ) { write(0, data); }
WRITE8_MEMBER( ym2413_device::data_port_w ) { write(1, data); }

//[ritz] const device_type YM2413 = &device_creator<ym2413_device>;
const device_type YM2413 = DEVICE_TYPE_YM2413;
