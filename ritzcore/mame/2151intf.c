...
const device_type YM2151 = (device_type)1;
...
READ8_MEMBER( ym2151_device::status_r ) { return read(1); }

WRITE8_MEMBER( ym2151_device::register_w ) { write(0, data); }
WRITE8_MEMBER( ym2151_device::data_w ) { write(1, data); }
